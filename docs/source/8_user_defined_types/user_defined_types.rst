...
.. code-block:: console
    ...
    /type field define <namespace> <Type> <Type> <name>
...
The first line is a constructor, which will be handled in :ref:`Constructors <user_defined_types_constructors>`. Assuming the constructor is defined as ``Location(Int x, Int y, Int z)`` and sets these variables respectively, the above will be the result.
...
.. code-block:: console
    ...
    /type method define <namespace> <Type> <ReturnType> <name>([Type name[, ...]])
...
They work exactly the same as any other Function described in the :ref:`Functions <functions>` chapter, except that they have access to the variables' state directly, through the *this* keyword, and that they have to be called on an instance.
...
Clearly this is a bit verbose, so look at :ref:`Paste.minr.org <script_paste>` for more information on how to simplify definitions.
